...
const featured = await fs.readFile(path.join(windowsRoot, "assets", "qq-reference.png"));
...
const cli = spawnSync(process.execPath, [helper, "--check", path.join(windowsRoot, "assets", "qq-reference.png")], {
  encoding: "utf8",
});
